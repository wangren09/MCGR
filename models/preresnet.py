...
class PreResNetBase(nn.Module):
    ...
    def __init__(self, num_classes,imgdim=1 ,depth=110):
        ...
        self.fc = nn.Linear(imgdim*64 * block.expansion, num_classes)
...
class PreResNetCurve(nn.Module):
    ...
    def __init__(self, num_classes, fix_points, depth=110,imgdim=1):
        ...
        self.relu = nn.ReLU(inplace=True)
        self.avgpool = nn.AvgPool2d(8)
        self.fc = curves.Linear(imgdim*64 * block.expansion, num_classes, fix_points=fix_points)
