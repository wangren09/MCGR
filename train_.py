...
if args.curve is None:
    ...
    if args.resume is None:
        ...
        if args.init_linear:
            ...
            model.init_linear()
print(torch.load(args.origin_model)['model_state'])
...
weights = torch.load(args.origin_model)['model_state']

weights_dict = {}
for k, v in weights.items():
    new_k = k.replace('module.', '') if 'module.' in key and if len(args.gpus)==0 else k
